...
export class VlMap extends VlElement(HTMLElement) {
  ...
  __updateOverviewMapSizeOnLoad() {
    window.addEventListener('load', this.__updateOverviewMapSize.bind(this),
        {once: true});
  }

  __updateMapSizeOnLoad() {
    window.addEventListener('load', this.__updateMapSize.bind(this),
        {once: true});
  }
  ...
  __initializeCoordinateSystem() {
    proj4.defs(this._porjectionCode,
