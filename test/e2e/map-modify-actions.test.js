...
describe('vl-map-modify-action', async () => {
  ...
  it('als gebruiker kan ik een punt aanpassen op een kaart', async () => {
    ...
    assert.notSameOrderedMembers(modifiedCoordinates, toWillebroek);
    console.log('Modified',modifiedCoordinates, toWillebroek);
    ...
    console.log('Unmodified',unmodifiedCoordinates, fromAntwerpen);
  });
